...
CREATE TABLE `easybuy_cart`  (
  ...
  `eu_userid` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `easybuy_news`  (
  ...
  `en_title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `en_content` varchar(10000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
...
INSERT INTO `easybuy_news` VALUES (16, 'dd', 'ddd', '2017-07-01');
...
CREATE TABLE `easybuy_product`  (
  ...
  `ep_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `ep_description` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `easybuy_product` VALUES (3, '巴黎圣母院 高老头', '商城正版 佳作必读丛书 青少版 茶花女 巴黎圣母院 高老头 海底两万里 悲惨世界 钢铁是怎样炼成的 假如给我三天光明 海的女儿   产品名称：复活 巴黎圣母院 钢铁是怎...是否是套装: 是书名: 复活 巴黎圣母院 钢铁是怎样炼成的 红与黑 高老头定价: 122.00元出版社名称: 中央编译出版社作者: 无书名: 复活 巴黎圣母院 钢铁是怎样炼成', 98, 10000, 0, 'images/Penguins.jpg');
...
INSERT INTO `easybuy_product` VALUES (23, '华为Mate 8（NXT-AL10/3GB RAM/全网通）', '4G网络：移动TD-LTE，	网络类型：双卡（均可支持4G），主屏尺寸：6英寸 1920x1080像素	CPU型号：海思 Kirin 950+微智CPU频率：2.3GHz（大四核），1.8GHz（小四核）	', 2550, 999, 9, 'images/17.jpg');
...
INSERT INTO `easybuy_product` VALUES (31, '12', '12', 12, 12, 1, 'fsdf');
INSERT INTO `easybuy_product` VALUES (32, '铁三角 Au', '123', 123, 123, 1, 'arrow_on.gif');
INSERT INTO `easybuy_product` VALUES (33, '铁三角 Au', 'qw', 12, 123, 1, '39.jpg');
INSERT INTO `easybuy_product` VALUES (35, '铁三角', '123', 12, 12, 1, 'bg.gif');
INSERT INTO `easybuy_product` VALUES (36, '铁三角', '123', 12, 12, 1, 'bg.gif');
...
CREATE TABLE `easybuy_product_parent`  (
  ...
  `epc_parent_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`epc_parent_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of easybuy_product_parent
-- ----------------------------
INSERT INTO `easybuy_product_parent` VALUES (1, '哈哈');
...
CREATE TABLE `easybuy_user`  (
  ...
  `eu_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  `eu_password` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `eu_sex` varchar(6) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `eu_birthday` date DEFAULT NULL,
  `eu_identity_code` varchar(18) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `eu_email` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `eu_mobile` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `eu_address` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- ----------------------------
INSERT INTO `easybuy_user` VALUES (1, 'sherry', '孙 ', '123456', 'female', '3899-12-01', '362426234522246675', 'sherry@163.com', '18573359008', '江西吉安', 0, 0);

...
<body>
	...
	<div id="main" class="wrap">
		...
		<div class="main">
			<h2>修改用户</h2>
			<div class="manage">
				<form id="update" method="get" action="../updateUser">
					<!--  from action="manage-result.html"-->
					<%
					...
					<table class="form">
						<tr>
							...
							<td><input type="text" class="text" name="userName"
								value=<%=user.getEuUserName()%> readonly="readonly" /></td>
						...
						<%String sex =  user.getEuSex();
						String sex2 = "";
						if(sex.equals("male") ){
							sex = "checked";sex2 = "";
						}
						else {sex = "";sex2 = "checked";}
							
						%>
						<tr> <input type="hidden" name="id" value = <%=id %> ></input>
							<td class="field">性别(*)：</td>
							<td><input type="radio" name="sex" value="male"
								<%=sex %> />男 <input type="radio" name="sex" value="female" <%=sex2 %>/>女</td>
						</tr>
						<tr>

...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>回复留言</h2>
		<div class="manage">
			<form action="MessageUpdateServlet">
				<table class="form">
				<%
				String ecid = request.getParameter("mess");
				request.setAttribute("ecid", ecid);
				MessageDao msgdao=new MessageDaoImpl();
				Message msg=msgdao.getMessage(Integer.valueOf(ecid.trim()));
				
				%>
				<input type="hidden" name="mess" value="${ecid }"/>
					<tr>
					...
					<tr>
						...
						<td><%=msg.getEcNickName()%></td>
					</tr>
					<tr>
						<td class="field">留言内容：</td>
						<td><%=msg.getEcContent()%></td>
					</tr>
					<tr>

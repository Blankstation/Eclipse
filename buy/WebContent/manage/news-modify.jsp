	...
	<div class="main">
		...
		<div class="manage">
			<form action="../NewsUpdateServlet">
				...
				News news=newsdao.getNews(Integer.valueOf(newsid.trim()));
				
				%>
					<input type="hidden" name="newid" value="<%=news.getEnId()%>"/>
					<tr>
						<td class="field">新闻标题：</td>
						<td><input type="text" class="text" name="title" value="<%=news.getEnTiTle() %>" /></td>
					</tr>
					<tr>

...
<body>
	<div id="header" class="wrap">
		...
		<div class="help">
			<a href="shopping.html" class="shopping">购物车X件</a><a
				href="login.html">登录</a><a href="register.html">注册</a><a
	...
	<div id="news" class="right-main">
		...
		String newsid = request.getParameter("en_id");
		...
		<div class="content"><%=news.getEnContent() %></div>

...
<div id="header" class="wrap">
	...
	<div class="help"><a href="shopping.html" class="shopping">购物车X件</a><a href="login.html">登录</a><a href="register.jsp">注册</a><a href="guestbook.html">留言</a><a href="manage/index.html">后台管理</a></div>
	<div class="navbar">
		<ul class="clearfix">
...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			<h1>欢迎注册易买网</h1><span style="color:red" id="msg"></span>
			...
			<form id="regForm" method="post" action="doReg" >
				<table>
					...
					<tr>
						...
						<input type="hidden" value="0" name = "euLogin"></input>
					</tr>
					<tr>
						<td></td>
